...
if (isset($_POST['submit_suggestion'])) {
    ...
    if ($stmt->execute()) {
        ...
        echo "<div class='alert alert-danger'>Error: Unable to submit suggestion.</div>";
    }
      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-12">
            <div class="card card-outline card-primary shadow-sm border">
                <div class="card-header">
                    <h3 class="card-title">Suggestion Box</h3>
                </div>
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <button type="submit" name="submit_suggestion" class="btn btn-primary btn-block">Submit</button>
                    </form>
                </div>
              <div class="card-footer">
                  <a href="suggestions.php" class="btn btn-secondary">View All Suggestions</a>
              </div>
